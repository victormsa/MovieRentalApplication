...
namespace RentalWorkPlease.Controllers
{
    ...
    public class GenresController : Controller
    {
        ...
        public GenresController(RentalWorkPleaseContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GenreID,GenreName,CreationDate,ActiveGenre")] Genre genre)
        {
            if (id != genre.GenreID)
            {
                return NotFound();
